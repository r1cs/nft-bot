...
func (_ISeaDrop *ISeaDropTransactor) UpdateCreatorPayoutAddress(opts *bind.TransactOpts, _payoutAddress common.Address) (*types.Transaction, error) {
	return _ISeaDrop.contract.Transact(opts, "updateCreatorPayoutAddress", _payoutAddress)
}

// UpdateCreatorPayoutAddress is a paid mutator transaction binding the contract method 0x12738db8.
//
// Solidity: function updateCreatorPayoutAddress(address _payoutAddress) returns()
func (_ISeaDrop *ISeaDropSession) UpdateCreatorPayoutAddress(_payoutAddress common.Address) (*types.Transaction, error) {
	return _ISeaDrop.Contract.UpdateCreatorPayoutAddress(&_ISeaDrop.TransactOpts, _payoutAddress)
}

// UpdateCreatorPayoutAddress is a paid mutator transaction binding the contract method 0x12738db8.
//
// Solidity: function updateCreatorPayoutAddress(address _payoutAddress) returns()
func (_ISeaDrop *ISeaDropTransactorSession) UpdateCreatorPayoutAddress(_payoutAddress common.Address) (*types.Transaction, error) {
	return _ISeaDrop.Contract.UpdateCreatorPayoutAddress(&_ISeaDrop.TransactOpts, _payoutAddress)
}
